...
##################
# REHEATING MODELS            
            "msqphisq-2fluids": {"potential_func": "msqphisq",
                                "pot_params": {"nfields": 1},
                                "nfields": 1,
                                ...
                                "solver": "rkdriver_rkf45",
                                "tend": 100,
                                "transfers": np.array([[7e-7, 7e-13]])},
            "hybquad-2fluids":  {"potential_func": "hybridquadratic",
                                "pot_params": {"nfields": 2},
                                "nfields": 2,
                                "bgystart": np.array([12.0, 1/300.0, 12.0,49/300.0,0,0,0]),
                                "cq": 50,
                                "solver": "rkdriver_rkf45",
                                "transfers_on_mintime":40.0,
                                "transfers": np.array([[7e-7, 7e-13],[7e-7, 7e-13]])},
            "hybquart-2fluids":  {"potential_func": "hybridquartic",
                                "pot_params": {"nfields": 2},
                                "nfields": 2,
                                "bgystart": np.array([1e-2, 2e-8, 1.63e-9,3.26e-7,0,0,0]),
                                "cq": 50,
                                "solver": "rkdriver_rkf45",
                                "tend": 69.0,
                                "transfers": np.array([[3e-11, 3e-17],[3e-11, 3e-17]]),
                                "transfers_on_mintime":40.0},
            "prodexp-2fluids":  {"potential_func": "productexponential",
                                "pot_params": {"nfields": 2},
                                "nfields": 2,
...
K_ranges = { "K1": {"kinit": 0.5e-61, "deltak": 1e-61, "numsoks": 1025},
             ...
             "KWMAP":{"kinit": 5.25e-60, "deltak": 5.25e-60, "numsoks":1},}
