...
def components_from_model(m, tix=None, kix=None):
    ...
    modes = adiabatic.getmodematrix(m.yresult[tslice, m.dps_ix, kslice], m.nfields)
    modesdot = adiabatic.getmodematrix(m.yresult[tslice, m.dpdots_ix, kslice], m.nfields)
    axis = 1
    Vphi, phidot, H, modes, modesdot, axis = correct_shapes(Vphi, phidot, H, modes, modesdot, axis)
